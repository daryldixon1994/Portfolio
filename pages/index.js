...
import nawar from "../public/nawar.jpg";
            ...
            <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
                <section className="min-h-screen">
                    ...
                    <div className="text-center p-10 py-10">
                        <h2 className="font-noto text-5xl py-2 text-teal-600 dark:text-teal-400 md:text-6xl">
                            Jabri Mohamed Anwar
                        </h2>
                        ...
                        <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
                            <a
                                href="https://www.facebook.com/mohamedanwar.jabri.1/"
                                target="_blank"
                            >
                                <AiFillTwitterCircle />
                            </a>
                            <a
                                href="https://www.linkedin.com/in/mohamed-anouar-jabri-40619b21a/"
                                target="_blank"
                            >
                                <AiFillLinkedin />
                            </a>
                            <a
                                href="https://github.com/daryldixon1994"
                                target="_blank"
                            >
                                <AiFillGithub />
                            </a>
